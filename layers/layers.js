...
lyr_kakka_0.setVisible(true);lyr_railways_1.setVisible(true);lyr_Rifugio_2.setVisible(true);lyr_tappe_3.setVisible(true);lyr_Partenzaearrivo_4.setVisible(true);lyr_Tragitto_5.setVisible(true);lyr_Rapida_6.setVisible(true);
var layersList = [lyr_kakka_0,lyr_railways_1,lyr_Rifugio_2,lyr_tappe_3,lyr_Partenzaearrivo_4,lyr_Tragitto_5,lyr_Rapida_6];
lyr_railways_1.set('fieldAliases', {'osm_id': 'osm_id', 'name': 'name', 'type': 'type', });
lyr_Rifugio_2.set('fieldAliases', {'id': 'id', 'nome': 'nome', });
lyr_tappe_3.set('fieldAliases', {'id': 'id', 'numero': 'numero', });
lyr_Partenzaearrivo_4.set('fieldAliases', {'id': 'id', });
lyr_Tragitto_5.set('fieldAliases', {'id': 'id', 'Name': 'Name', 'Terrain': 'Terrain', });
lyr_Rapida_6.set('fieldAliases', {'id': 'id', 'Difficolta': 'Difficolta', });
lyr_railways_1.set('fieldImages', {'osm_id': '', 'name': '', 'type': '', });
lyr_Rifugio_2.set('fieldImages', {'id': 'TextEdit', 'nome': 'TextEdit', });
lyr_tappe_3.set('fieldImages', {'id': 'TextEdit', 'numero': 'TextEdit', });
lyr_Partenzaearrivo_4.set('fieldImages', {'id': 'TextEdit', });
lyr_Tragitto_5.set('fieldImages', {'id': 'TextEdit', 'Name': 'TextEdit', 'Terrain': 'TextEdit', });
lyr_Rapida_6.set('fieldImages', {'id': 'TextEdit', 'Difficolta': 'TextEdit', });
lyr_railways_1.set('fieldLabels', {'osm_id': 'no label', 'name': 'inline label - always visible', 'type': 'no label', });
lyr_Rifugio_2.set('fieldLabels', {'id': 'no label', 'nome': 'no label', });
lyr_tappe_3.set('fieldLabels', {'id': 'no label', 'numero': 'no label', });
lyr_Partenzaearrivo_4.set('fieldLabels', {'id': 'no label', });
lyr_Tragitto_5.set('fieldLabels', {'id': 'no label', 'Name': 'no label', 'Terrain': 'no label', });
lyr_Rapida_6.set('fieldLabels', {'id': 'no label', 'Difficolta': 'no label', });
